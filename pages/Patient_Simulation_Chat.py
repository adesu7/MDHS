        ...
        for response in client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content":f""" You will role-play as Alena, a 41-year-old patient, who visits the Royal Melbourne Dental Hospital for a check-up with a student practitioner. 
                    ...
                    - Current issues: Pain on the left side of her face and hypersensitivity on the upper right side.

                    Pain Descriptions:
                    1. Pain (left side): Sudden onset two weeks ago, feels cold, prickly, reduced sensation, constant, alleviated slightly with heat.
